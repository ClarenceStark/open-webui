...
{#if loaded}
	<div
		class=" flex flex-col h-screen max-h-[100dvh] flex-1 transition-width duration-200 ease-in-out pwa-safe-shell {$showSidebar
	...
	>
		...
		<div class="  pb-1 flex-1 max-h-full overflow-y-auto pwa-scroll-region">
			<slot />
		</div>
	</div>
{/if}
